...
ACHABITATION est une application de partage de dépenses au reste à vivre. Le projet est désormais séparé en plusieurs modules : `backend-api` pour l’API Spring Boot, `frontend-web` pour l’interface navigateur, `mobile-android` et `mobile-ios` pour les futurs clients mobiles. L’ancien client Swing est conservé dans `desktop-legacy` comme référence historique.
...
La règle centrale est isolée dans le package `domain` : le moteur de calcul ne dépend ni de Spring, ni de JPA, ni du web. C’est un bon point de conception : le calcul peut être testé indépendamment et consommé par n’importe quel client via l’API.
...
fr.achabitation.config               Configuration sécurité et CORS
...
### `backend-api/src/main/java/fr/achabitation/AchabitationApplication.java`
...
### `backend-api/src/main/java/fr/achabitation/api/controller/ApiExceptionHandler.java`
...
### `backend-api/src/main/java/fr/achabitation/api/controller/AuditController.java`
...
### `backend-api/src/main/java/fr/achabitation/api/controller/AuthController.java`
...
### `backend-api/src/main/java/fr/achabitation/api/controller/ExpenseController.java`
...
### `backend-api/src/main/java/fr/achabitation/api/controller/ExportController.java`
...
### `backend-api/src/main/java/fr/achabitation/api/controller/HealthController.java`
...
### `backend-api/src/main/java/fr/achabitation/api/controller/PersonController.java`
...
### `backend-api/src/main/java/fr/achabitation/api/controller/SummaryController.java`
...
### `backend-api/src/main/java/fr/achabitation/api/controller/TripController.java`
...
### `backend-api/src/main/java/fr/achabitation/api/dto/AuditDtos.java`
...
### `backend-api/src/main/java/fr/achabitation/api/dto/AuthDtos.java`
...
### `backend-api/src/main/java/fr/achabitation/api/dto/ExpenseDtos.java`
...
### `backend-api/src/main/java/fr/achabitation/api/dto/PersonDtos.java`
...
### `backend-api/src/main/java/fr/achabitation/api/dto/SummaryDtos.java`
...
### `backend-api/src/main/java/fr/achabitation/api/dto/TripDtos.java`
...
### `backend-api/src/main/java/fr/achabitation/application/AuditQueryService.java`
...
### `backend-api/src/main/java/fr/achabitation/application/AuditService.java`
...
### `backend-api/src/main/java/fr/achabitation/application/AuthContextService.java`
...
### `backend-api/src/main/java/fr/achabitation/application/AuthService.java`
...
### `backend-api/src/main/java/fr/achabitation/application/AuthorizationService.java`
...
### `backend-api/src/main/java/fr/achabitation/application/EntityMapper.java`
...
### `backend-api/src/main/java/fr/achabitation/application/ExpenseService.java`
...
### `backend-api/src/main/java/fr/achabitation/application/ExportService.java`
...
### `backend-api/src/main/java/fr/achabitation/application/PersonService.java`
...
### `backend-api/src/main/java/fr/achabitation/application/SummaryService.java`
...
### `backend-api/src/main/java/fr/achabitation/application/TripService.java`
...
### `backend-api/src/main/java/fr/achabitation/domain/model/Balance.java`
...
### `backend-api/src/main/java/fr/achabitation/domain/model/DomainExpense.java`
...
### `backend-api/src/main/java/fr/achabitation/domain/model/DomainPerson.java`
...
### `backend-api/src/main/java/fr/achabitation/domain/model/ExpenseType.java`
...
### `backend-api/src/main/java/fr/achabitation/domain/model/PresencePeriod.java`
...
### `backend-api/src/main/java/fr/achabitation/domain/model/Settlement.java`
...
### `backend-api/src/main/java/fr/achabitation/domain/model/WeightMode.java`
...
### `backend-api/src/main/java/fr/achabitation/domain/util/ConstraintNameUtils.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/entity/AuditAction.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/entity/AuditLogEntity.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/entity/ExpenseEntity.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/entity/ExpenseParticipantEntity.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/entity/PersonEntity.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/entity/PresencePeriodEntity.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/entity/TripEntity.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/entity/TripInvitationEntity.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/entity/TripMemberEntity.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/entity/TripRole.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/entity/UserEntity.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/repository/AuditLogRepository.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/repository/ExpenseRepository.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/repository/PersonRepository.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/repository/TripInvitationRepository.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/repository/TripMemberRepository.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/repository/TripRepository.java`
...
### `backend-api/src/main/java/fr/achabitation/infrastructure/repository/UserRepository.java`
...
### `backend-api/src/test/java/fr/achabitation/api/AchabitationApiIntegrationTest.java`
...
### `backend-api/src/test/java/fr/achabitation/application/AuthServiceTest.java`
...
### `backend-api/src/test/java/fr/achabitation/application/EntityMapperTest.java`
...
### `backend-api/src/test/java/fr/achabitation/domain/BalanceCalculatorTest.java`
...
### `backend-api/src/test/java/fr/achabitation/domain/model/PresencePeriodTest.java`
...
## Évolution : création directe d’une personne liée au compte connecté

Le parcours d’invitation ne s’arrête plus à l’ajout du compte dans le voyage. Après avoir rejoint un voyage avec un code, l’utilisateur doit pouvoir dire quelle personne du voyage il représente.

Deux cas sont prévus :

- rattacher le compte à un guest déjà existant ;
- créer une nouvelle personne directement liée au compte connecté.

### `PersonDtos.CurrentUserPersonCreateRequest`

DTO utilisé par la route de création directe d’une personne liée au compte connecté.

Champs :

- `name` : nom à donner à la personne dans le voyage ; s’il est vide, le backend utilise le nom affiché du compte ;
- `applyProfileToPerson` : indique si les données du profil utilisateur doivent être copiées sur la personne créée ;
- `presencePeriods` : périodes de présence dans le voyage.

### `PersonController.createForCurrentUser(...)`
...
Cette route est utilisée quand un utilisateur veut s’ajouter lui-même à un voyage sans passer par la création d’un guest puis par la liaison du guest.

### `PersonService.createForCurrentUser(...)`

Méthode applicative centrale de cette évolution.

Elle vérifie :

- que l’utilisateur est authentifié ;
- que l’utilisateur a un rôle permettant de modifier le voyage ;
- que le compte n’est pas déjà lié à une personne du voyage ;
- que le nom choisi est unique ;
- que les périodes de présence sont valides ;
- que le profil utilisateur est exploitable si l’utilisateur demande son application.

Si `applyProfileToPerson` vaut `true`, la méthode appelle `AuthService.applyUserProfileToPerson(...)`.

Si `applyProfileToPerson` vaut `false`, la personne est créée avec un poids `AVERAGE`, ce qui permet de créer une représentation valide même lorsque le profil utilisateur ne contient pas encore de RAV exploitable.
